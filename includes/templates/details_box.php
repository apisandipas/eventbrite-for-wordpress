...
<p>
    ...
    <input type="hidden" id="start_date" name="event[start_date]" class="widefat" value="<?php echo $start_date ?>" />
    <input type="text" id="user_start_date"/>@
...
<p>
    ...
    <input type="hidden" id="end_date" name="event[end_date]" class="widefat" value="<?php echo $end_date; ?>" />
    <input type="text" id="user_end_date"/>@
    <select id="user_end_time">
        <?php echo EB::select_time_helper(); ?>
    </select>
